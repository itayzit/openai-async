...
<br><br>
Visit the official docs for more info: https://beta.openai.com/docs/api-reference/images/create
...
Visit the [official docs](https://beta.openai.com/docs/api-reference/embeddings) for more info.
